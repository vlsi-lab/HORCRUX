...
FP_ELEM G_vec_by_vec_pointwise(FP_ELEM a, FP_ELEM b)
{
    FP_ELEM out;
    asm volatile (
        "addi t0, %1, 0\n\t"                
        ".insn r 0x6b, 0x05, 0x1, %0, t0, %2\n\t"
        : "=&r"(out)  : "r"(a), "r"(b) : "t0", "cc"                       
    );
    return out;
}
...
int main() {
    ...
    const FP_ELEM in1[N_K] = {
        ...
        54, 99, 195, 445,  20, 256, 438, 350, 376,  21
    };
    ...
    const FP_ELEM in2[N_K] = {
        ...
        471, 55, 428, 270,  91, 409, 196, 198, 474,  20
    };
    ...
    const FP_ELEM golden_res[N_K] = {
        ...
        493, 355, 493,  26, 293, 359, 336,  76,  74, 420
    };
    ...
    for (int i = 0; i < N_K; i++){  
        ...
        //    : "cc", "a3", "a5"
        //    );
        computed_res_hw[i] = G_vec_by_vec_pointwise(in1[i], in2[i]);
