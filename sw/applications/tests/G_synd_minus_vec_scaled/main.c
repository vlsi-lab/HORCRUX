...
FP_ELEM G_synd_minus_vec_scaled(FP_ELEM a, FP_ELEM b, FP_ELEM c)
{
    FP_ELEM out;
    asm volatile (
        "addi t0, %1, 0\n\t"                
        ".insn r 0x6b, 0x05, 0x3, %0, t0, %2, %3\n\t"
...
int main() {
    ...
    FP_ELEM s[N_K] = {
        ...
        195,   1, 182,  22, 406, 399, 426, 396, 119, 214,
        214,  72, 149,  24, 252, 103, 376, 452, 486, 402,
        195,   1, 182,  22, 406, 399, 426, 396, 119, 214,
        214,  72, 149,  24, 252, 103, 376, 452, 486, 402
    };
    ...
    FP_ELEM synd[N_K] = {
        ...
        226, 202, 179, 220, 355,  66, 250,  33, 369, 459,
        459, 219, 479, 481, 138, 403, 348, 477,  44,  34,
        226, 202, 179, 220, 355,  66, 250,  33, 369, 459,
        459, 219, 479, 481, 138, 403, 348, 477,  44,  34
    };
    ...
    FP_ELEM golden_res[N_K] = {
        ...
        406, 477, 347, 162,  25, 356, 330,   7,   9, 265, 
        265, 168, 225, 464, 214, 224, 421,  72, 336, 131,
        406, 477, 347, 162,  25, 356, 330,   7,   9, 265, 
        265, 168, 225, 464, 214, 224, 421,  72, 336, 131
    };
    ...
    for (int j = 0; j < N_K; j++) {
            ...
            //: "cc", "a3", "a5");
            computed_res_hw[j] = G_synd_minus_vec_scaled(s[j], chall_1, synd[j]);
